...
import { InstructorProfile, SocialMedia } from 'src/app/core/models/user.model';
import { AuthService } from 'src/app/core/services/auth.service';
import { ProfileService } from 'src/app/core/services/profile.service';

@Component({
  selector: 'app-instructor-social-media',
  templateUrl: './instructor-social-media.component.html',
  styleUrls: ['./instructor-social-media.component.css']
})
export class InstructorSocialMediaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.instructorId && role === 'instructor') {
      this.initializeForm();
      this.loadInstructorSocialMedia();
    } else {
...
loadInstructorSocialMedia(): void {
  this.isLoading = true;

  this.profileService.getInstructorSocialMedia(this.instructorId).subscribe({
    next: (data) => {
...
updateSocialMediaForm(): void {
  ...
  this.profileService.updateInstructorSocialMedia(this.instructorId, payload).subscribe({
    next: () => {
