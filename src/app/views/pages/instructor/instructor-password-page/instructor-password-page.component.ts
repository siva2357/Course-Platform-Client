...
@Component({
  selector: 'app-instructor-password-page',
  templateUrl: './instructor-password-page.component.html',
  styleUrls: ['./instructor-password-page.component.css']
})
export class InstructorPasswordPageComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    if (this.changePasswordForm.valid) {
      ...
      const role = localStorage.getItem('userRole');
        this.passwordService.changeInstructorPassword(this.userId, passwordModel).subscribe(
          (response) => {
