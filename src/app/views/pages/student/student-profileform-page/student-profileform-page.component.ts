...
import { Student, StudentProfile } from 'src/app/core/models/user.model';
...
@Component({
  selector: 'app-student-profileform-page',
  templateUrl: './student-profileform-page.component.html',
  styleUrls: ['./student-profileform-page.component.css']
})
export class StudentProfileformPageComponent implements OnInit, OnDestroy{
...
submitProfile() {
  ...
  this.profileService.postStudentProfile(profileData).subscribe({
    next: () => {
